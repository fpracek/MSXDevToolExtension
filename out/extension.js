...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('msxdevtool.msxdevtoolView', () => {
    ...
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('msxDevToolWebview', webviewProvider));
}
...
//  }
//}
class MSXDevToolWebviewProvider {
